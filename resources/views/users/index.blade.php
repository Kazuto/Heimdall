...
<div class="card">
    <header class="card__header">
        ...
        <div class="card__actions">
            <a href="{{ route('users.create', []) }}" title="" class="card__action"><i class="fa fa-plus"></i><span>{{ __('app.buttons.add') }}</span></a>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a{{ $user->target }} href="{!! route('users.edit', [$user->id]) !!}" title="{{ __('user.settings.edit') }} {!! $user->title !!}"><i class="fas fa-edit"></i></a>
                    </td>
                    <td class="text-center">
                        @if($user->id !== 1)
