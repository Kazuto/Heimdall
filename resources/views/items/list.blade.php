...
<div class="card">
    <header class="card__header">
        ...
        <div class="card__actions">
            <a href="{{ route('applist', []) }}" class="card__action"><i class="fa fa-cloud-download"></i><span>{{ __('app.buttons.downloadapps') }}</span></a>
            <a href="{{ route('items.create', []) }}" title="" class="card__action"><i class="fa fa-plus"></i><span>{{ __('app.buttons.add') }}</span></a>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a{{ $app->target }} href="{!! route('items.edit', [$app->id]) !!}" title="{{ __('app.settings.edit') }} {!! $app->title !!}"><i class="fas fa-edit"></i></a>
                    </td>
                    <td class="text-center">
